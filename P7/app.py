...
def openDb():
    global conn, cursor
    conn = pymysql.connect(host="localhost",user="root",passwd="feli",database="stok")
    cursor = conn.cursor()
...
#fungsi view tambah() untuk membuat form tambah() untuk membuat form tambah
...
def tambah():
    if request.method == 'POST':
        ...
        openDb()
        sql = "INSERT INTO barang (kode_barang, nama_barang, harga, jumlah) VALUE (%s, %s, %s, %s)"
