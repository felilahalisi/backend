...
try:
    ...
    cursor.execute("INSERT INTO data_siswa (nama, email) VALUES ('Feli', 'feli@example.com')")
    cursor.execute("INSERT INTO data_siswa (nama, email) VALUES ('jeno', 'jeno@example.com')")
    sqliteConnection.commit()
